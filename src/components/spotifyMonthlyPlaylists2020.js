...
export const SpotifyMonthlyPlaylists2020 = () => {
    const data = useStaticQuery(graphql`query SpotifyMonthlyPlaylists2020 {
  allSpotifyPlaylist(
    filter: {name: {glob: "*2020*"}}
    sort: {fields: order}
    limit: 1500
  ) {
    edges {
...
export default SpotifyMonthlyPlaylists2020