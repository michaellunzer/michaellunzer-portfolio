...
export const SpotifyMonthlyPlaylists2015 = () => {
    const data = useStaticQuery(graphql`query SpotifyMonthlyPlaylists2015 {
  allSpotifyPlaylist(
    filter: {name: {glob: "*2015*"}}
    sort: {fields: order}
    limit: 1500
  ) {
    edges {
...
export default SpotifyMonthlyPlaylists2015