...
export const SpotifyMonthlyPlaylists2018 = () => {
    const data = useStaticQuery(graphql`query SpotifyMonthlyPlaylists2018 {
  allSpotifyPlaylist(
    filter: {name: {glob: "*2018*"}}
    sort: {fields: order}
    limit: 1500
  ) {
    edges {
...
export default SpotifyMonthlyPlaylists2018