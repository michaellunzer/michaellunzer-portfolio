...
export const SpotifyMonthlyPlaylists2016 = () => {
    const data = useStaticQuery(graphql`query SpotifyMonthlyPlaylists2016 {
  allSpotifyPlaylist(
    filter: {name: {glob: "*2016*"}}
    sort: {fields: order}
    limit: 1500
  ) {
    edges {
...
export default SpotifyMonthlyPlaylists2016