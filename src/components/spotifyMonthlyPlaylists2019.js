...
export const SpotifyMonthlyPlaylists2019 = () => {
    const data = useStaticQuery(graphql`query SpotifyMonthlyPlaylists2019 {
  allSpotifyPlaylist(
    filter: {name: {glob: "*2019*"}}
    sort: {fields: order}
    limit: 1500
  ) {
    edges {
...
export default SpotifyMonthlyPlaylists2019