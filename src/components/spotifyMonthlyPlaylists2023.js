...
export const SpotifyMonthlyPlaylists2023 = () => {
    const data = useStaticQuery(graphql`query SpotifyMonthlyPlaylists2023 {
  allSpotifyPlaylist(
    filter: {name: {glob: "*2023*"}}
    sort: {fields: order}
    limit: 1500
  ) {
    edges {
...
export default SpotifyMonthlyPlaylists2023