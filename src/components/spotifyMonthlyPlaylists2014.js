...
export const SpotifyMonthlyPlaylists2014 = () => {
    const data = useStaticQuery(graphql`query SpotifyMonthlyPlaylists2014 {
  allSpotifyPlaylist(
    filter: {name: {glob: "*2014*"}}
    sort: {fields: order}
    limit: 50
  ) {
    edges {
...
export default SpotifyMonthlyPlaylists2014