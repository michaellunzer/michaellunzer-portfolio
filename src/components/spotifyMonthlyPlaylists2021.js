...
export const SpotifyMonthlyPlaylists2021 = () => {
    const data = useStaticQuery(graphql`query SpotifyMonthlyPlaylists2021 {
  allSpotifyPlaylist(
    filter: {name: {glob: "*2021*"}}
    sort: {fields: order}
    limit: 1500
  ) {
    edges {
...
export default SpotifyMonthlyPlaylists2021