...
export const SpotifyMonthlyPlaylists2022 = () => {
    const data = useStaticQuery(graphql`query SpotifyMonthlyPlaylists2022 {
  allSpotifyPlaylist(
    filter: {name: {glob: "*2022*"}}
    sort: {fields: order}
    limit: 1500
  ) {
    edges {
...
export default SpotifyMonthlyPlaylists2022