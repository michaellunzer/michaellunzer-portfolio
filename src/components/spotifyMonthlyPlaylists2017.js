...
export const SpotifyMonthlyPlaylists2017 = () => {
    const data = useStaticQuery(graphql`query SpotifyMonthlyPlaylists2017 {
  allSpotifyPlaylist(
    filter: {name: {glob: "*2017*"}}
    sort: {fields: order}
    limit: 1500
  ) {
    edges {
...
export default SpotifyMonthlyPlaylists2017